package com.qhit.lh.gr3.merida.exam.bjgl.bean;
...
public class ClassInfo  implements java.io.Serializable {
	...
	/** minimal constructor */
    public ClassInfo(String cname, String major, Integer insId, Integer iecId, Date cdate) {
        this.cname = cname;
        this.major = major;
        this.insId = insId;
        this.iecId = iecId;
    ...
    /** full constructor */
    public ClassInfo(String cname, String major, Integer insId, Integer iecId, Date cdate, Integer g1num, Integer g2num, Integer g3num, Integer csId, String cremark) {
        this.cname = cname;
        this.major = major;
        this.insId = insId;
        this.iecId = iecId;
